import { FiBookOpen, FiCheck, FiRefreshCw, FiTrash2 } from "react-icons/fi";
    ...
    <div className="group relative">
      ...
      >
        ...
        <div className="relative z-10 flex min-w-0 flex-1 flex-col justify-between">
          <div>
            <p className="line-clamp-2 pr-20 text-lg font-bold leading-snug text-white sm:text-xl">
              {subject.name}
            </p>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-1.5">
            ...
            {canUpdate && (
              <button
                type="button"
                disabled={updating}
                className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[10px] font-bold shadow-sm transition disabled:opacity-60 ${
                  hasUpdate
              ...
              >
                ...
                {hasUpdate ? `Update (${newCount})` : "Update subject"}
              </button>
            )}
          </div>
        </div>
